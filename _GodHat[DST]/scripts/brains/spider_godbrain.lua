...
local Spider_GodBrain = Class(Brain, function(self, inst)
...
function Spider_GodBrain:OnStart()
    local root =
        PriorityNode(
        {
...
-- function Spider_GodBrain:OnInitializationComplete()
--     self.inst.components.knownlocations:RememberLocation("home", Point(self.inst.Transform:GetWorldPosition()))
-- end

return Spider_GodBrain
